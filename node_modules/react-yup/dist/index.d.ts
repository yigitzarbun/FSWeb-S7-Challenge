...
export interface ValidateFormOptions<FormValues extends Record<string, unknown>> {
	touch?: boolean;
	validationSchema?: Schema<FormValues>;
}
...
export interface FormBagContext<FormValues extends Record<string, unknown>> {
	...
	resetErrors: () => void;
	validateForm: (options?: ValidateFormOptions<FormValues>) => ValidateFormResult<FormValues>;
	validateField: (name: string, values: ValueState<FormValues>, shouldTouch?: boolean) => Promise<unknown>;
}
export interface UseFormHookResult<FormValues extends Record<string, unknown>> extends FormBagContext<FormValues> {
	values: ValueState<FormValues>;
	errors: ErrorState<FormValues>;
...
declare const FormBagContext: React.Context<FormBagContext<Record<string, unknown>>>;
